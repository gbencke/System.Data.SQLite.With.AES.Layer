...
{
    public class SQLite3UnitTests
    {
        private static int NumThreads = 16;
        private static int ThreadTimeout = 60000;
        private static long logevents = 0;

        private static DbConnection _cnn;
        private static DbProviderFactory _fact;
        private static DbConnectionStringBuilder _cnnstring;
        ...
        internal static void BinaryInsert()
        {
        ...
        internal static void CheckSQLite()
        {
            if (_fact.GetType().Name.IndexOf("SQLite", StringComparison.OrdinalIgnoreCase) == -1)
        ...
        internal static void ParseTest()
        {
...
";
        ...
        internal static void DataTypesSchema()
        {
        ...
        /// </summary>
        internal static string DataAdapter(bool bWithIdentity)
        {
        ...
        internal static void MultithreadedTestThread(object obj)
        {
        ...
        internal static void TimeoutTest()
        {
            CheckSQLite();
    ...
    internal abstract class TestCaseBase
    {
        ...
        protected TestCaseBase()
        {
            ...
            {
                var sw = new StreamWriter("methods.txt", true);
                sw.WriteLine(pair.Value.Name);
                sw.Close();
